    ...
    <div class="py-12">
      <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-3">
        <form @submit.prevent="createPost" class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
          ...
          <textarea v-model="form.body" @focus="form.clearErrors('body')" name="body" id="body" cols="30" rows="5"
        ...
        <div class="text-center">
          <Link :href="route('posts')" preserve-scroll :only="['posts']" type="button" class="text-sm text-indigo-600">
            Refresh Posts
          </Link>
        </div>
